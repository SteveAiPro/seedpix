...
export const toolExtraContent: Record<string, ToolExtraContent> = {
  ...
  "ai-image-humanizer": {
    whyUse:
      "Synthetic images from Midjourney, Stable Diffusion, or Flux often scream 'AI' due to excessive plastic sheen, porcelain-smooth skin without pores, and hyper-uniform lighting. SeedPix AI Image Humanizer specifically deconstructs these synthetic artifacts: it rebuilds micro-textures, subtle dermal variations, realistic film noise, and authentic camera light falloff so the output reads as genuine photography.",
    useCases: [
      {
        title: "Make AI portraits believable for profiles and resumes",
        text: "Replace waxy, oversmoothed faces with lifelike skin texture and realistic depth that looks like studio photography.",
      },
      {
        title: "Humanize AI product photos for e-commerce",
        text: "Synthetic product visuals frequently look unrealistically sterile. Adding photographic micro-shadows and natural reflections builds customer trust.",
      },
      {
        title: "Prepare AI visuals for print and high-res media",
        text: "Banding and plastic-smooth gradients fail in print. Humanizing the image injects organic grain and optical texture.",
      },
    ],
    steps: [
      {
        ...
        description:
          "Drop any JPG, PNG, or WebP generated by Midjourney, Flux, Stable Diffusion, or ChatGPT.",
      },
      {
        title: "Click Humanize",
        description:
          "The neural engine detects synthetic artifacts and regenerates authentic photographic details.",
      },
      {
        title: "Download watermark-free",
        description:
          "Save the photorealistic image at full resolution ready for commercial or personal use.",
      },
    ],
    extraFaqs: [
      {
        question: "Can AI image humanizer bypass AI content detectors?",
        answer:
          "Our tool focuses on visual realism for human viewers by eliminating synthetic visual artifacts. While it often alters statistical pixel patterns, we encourage transparent and ethical use of generated imagery.",
      },
      {
        question: "Does humanizing an image alter the person's face?",
        answer:
          "No. Identity, facial structure, eye shape, and expressions remain identical. The tool only refines skin surface textures, micro-lighting, and photographic noise.",
      },
    ],
  },
  ...
  "remove-ai-look": {
    whyUse:
      "The 'AI look' comes down to a lack of camera physics: surfaces are too smooth, lighting lacks bounce variations, and edges look unnaturally sharp or smudged. The Remove AI Look engine reintroduces authentic camera optics, balanced contrast, and delicate surface grain so images feel captured rather than computed.",
    useCases: [
      {
        title: "Fix plastic skin in AI headshots",
        text: "Restore natural skin pores and realistic specular highlights so portraits look like real people.",
      },
      {
        title: "De-AI marketing and social media graphics",
        text: "Avoid audience fatigue from obvious AI stock images by making visuals look organically photographed.",
      },
      {
        title: "Clean up AI landscape and architectural renderings",
        text: "Add natural atmospheric haze and surface weathering to overly pristine synthetic renders.",
      },
    ],
    steps: [
      {
        title: "Upload the AI photo",
        description: "Upload any image that has the noticeable plastic or waxy AI look.",
      },
      {
        title: "Apply Remove AI Look",
        description: "The engine softens synthetic edges, fixes unnatural contrast, and injects realistic camera grain.",
      },
      {
        title: "Export realistic result",
        description: "Download the natural-looking photo without watermarks.",
      },
    ],
    extraFaqs: [
      {
        question: "How is this different from applying a photo filter?",
        answer:
          "A regular filter merely shifts global colors or adds an overlay. Remove AI Look reconstructs pixels contextually based on lighting physics and dermal anatomy.",
      },
      {
        question: "Does it work on illustrations or only photos?",
        answer:
          "It is designed primarily for photorealistic AI generations. On 2D illustrations or cartoons, it softens harsh synthetic artifacts but keeps the illustrative style.",
      },
    ],
  },
  ...
  "remove-tattoo-from-photo": {
    whyUse:
      "Tattoos carry deeply personal meaning, but certain formal situations—job applications, corporate headshots, conservative visa photos, or wedding pictures—may call for a tattoo-free appearance. Manually airbrushing tattoos in Photoshop takes hours and often leaves blurry, discolored smudges. SeedPix AI Tattoo Removal uses generative inpainting to seamlessly reconstruct clean, authentic skin texture and natural pores matching your exact skin tone.",
    useCases: [
      {
        title: "Corporate headshots & LinkedIn profiles",
        text: "Present a conservative, formal appearance for executive profiles, corporate rosters, or job applications.",
      },
      {
        title: "Wedding & family keepsake photos",
        text: "Create traditional portraits for grandparents, formal wedding albums, or cultural events where un-inked skin is preferred.",
      },
      {
        title: "Pre-laser tattoo removal preview",
        text: "Preview how your skin, arms, neck, or chest will look once your tattoo is removed before booking expensive laser removal sessions.",
      },
    ],
    steps: [
      {
        title: "Upload your photo",
        description: "Upload any clear photo showing the tattoo you want to remove.",
      },
      {
        title: "Brush or select the tattoo",
        description: "Simply highlight the ink area, or let the AI detect and erase the tattoo automatically.",
      },
      {
        title: "Download clean, natural skin",
        description: "Get a seamless result with natural skin pores and matching lighting in seconds.",
      },
    ],
    extraFaqs: [
      {
        question: "Does tattoo removal work on colored and dark ink?",
        answer:
          "Yes. Whether the tattoo is black and grey, vibrant color, watercolor, or heavily shaded linework, the AI inpainting model cleanly replaces the pigment with natural skin tone.",
      },
      {
        question: "Will the skin look blurry or plastic where the tattoo was?",
        answer:
          "No. The AI samples surrounding skin texture, hair, freckles, and light falloff to reconstruct believable, detailed skin rather than a blurred patch.",
      },
      {
        question: "Is my uploaded photo kept private?",
        answer:
          "Yes. Your photos are processed securely in real time and are never used for public training or shared with third parties.",
      },
    ],
  },
