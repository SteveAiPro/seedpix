...
export default function HomePage() {
  ...
  // before/after 演示工具（按 slug 精挑，after 图各不相同、效果反差大）
  const demoSlugs = [
          ...
          <div className="mx-auto max-w-6xl px-4 py-14">
            <div className="mb-8 text-center">
              ...
              <p className="mx-auto mt-2 max-w-2xl text-sm text-neutral-500">
                Real SeedPix edits. Slide the handle to see each photo before and
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {demoPairs.map(({ tool, before, after }) => (
                <div key={tool.slug}>
                  ...
                  <Link
                    href={`/${tool.slug}`}
                    className="mt-2 block text-center text-xs font-medium text-blue-600 hover:text-blue-700"
                  >
                    Try it free →
                  </Link>
                </div>
